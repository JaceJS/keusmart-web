...
export function TimeRangeSelector({
  ...
  const handleAdditionalPresetClick = (
    preset: (typeof additionalPresets)[number],
  ) => {
          ...
          <div className="flex">
            ...
            >
              ...
              {additionalPresets.map((preset) => (
                <button
                  key={preset.id}
                  onClick={() => handleAdditionalPresetClick(preset)}
